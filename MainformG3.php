...
if($_COOKIE["start"]==6){
store_ans($_POST['ansF2'],"ansF2");
store_time($_COOKIE['start_timeF2'],"take_timeF2");
}else{
store_ans($_POST['ansF3'],"ansF3");
store_time($_COOKIE['start_timeF3'],"take_timeF3");
}

set_startTime("start_timeG3");
...
<div class="program">
    ...
    <div class = "Ptext">
      <?php
        echo file_get_contents("Qprograms2/G3.txt");
       ?>
    </div>
</div>
...
<div class="check-form">
  <input type="radio" name="ansG3" value="1" required> true <br>
  <input type="radio" name="ansG3" value="2"> false <br>
  <div class="buttom">
...
<?php else: ?>
  <form method="post" action="MainformH3.php">
