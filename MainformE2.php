...
<div class="program">
    ...
    <div class = "Ptext">
      <?php
        echo file_get_contents("Qprograms2/E2.txt");
       ?>
    </div>
</div>
...
<div class="check-form">
  <input type="radio" name="ansE2" value="1" required> 9 <br>
  <input type="radio" name="ansE2" value="2"> 10 <br>
  <input type="radio" name="ansE2" value="3"> 15 <br>
  <input type="radio" name="ansE2" value="4"> 19 <br>
  <input type="radio" name="ansE2" value="5"> 20 <br>
  <div class="buttom">
