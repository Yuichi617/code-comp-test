...
<div class="check-form">
  <input type="radio" name="ansH1" value="1" required> 5, 2 <br>
  <input type="radio" name="ansH1" value="2"> 5, 3 <br>
  <input type="radio" name="ansH1" value="3"> 6, 2 <br>
  <input type="radio" name="ansH1" value="4"> 7, 2 <br>
  <input type="radio" name="ansH1" value="5"> 7, 3 <br>
  <div class="buttom">
