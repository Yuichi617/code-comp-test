...
store_ans($_POST['ansH00'],"ansH00");
store_time($_COOKIE['start_timeH00'],"take_timeH00");
}

set_startTime("start_timeI00");
...
<div class="program">
    ...
    <div class = "Ptext">
      <?php
        echo file_get_contents("Qprograms2/I00.txt");
       ?>
    </div>
</div>
...
<div class="check-form">
  <input type="radio" name="ansI00" value="1" required> 0 <br>
  <input type="radio" name="ansI00" value="2"> 1 <br>
  <input type="radio" name="ansI00" value="3"> 2 <br>
  <input type="radio" name="ansI00" value="4"> 3 <br>
  <input type="radio" name="ansI00" value="5"> 9 <br>
  <div class="buttom">
