...
<div class="program">
    ...
    <div class = "Ptext">
      <?php
        echo file_get_contents("Qprograms2/B1'.txt");
       ?>
    </div>
</div>
...
<div class="check-form">
  <input type="radio" name="ansB1d" value="1" required> true <br>
  <input type="radio" name="ansB1d" value="2"> false <br>
  <div class="buttom">
